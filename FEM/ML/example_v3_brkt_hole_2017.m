...
distributedLoad = 5e4; % Applied load in Pascals
structuralBoundaryLoad (model,'Face',8,'SurfaceTraction',[0,0,-distributedLoad]);

%% Discretization
hmax = 0.1; % Thickness of horizontal plate with hole, meters
...
minUz = max(abs(result.Displacement.uz));
...
%% Stress recovery at user defined locations.
