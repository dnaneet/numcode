...
importGeometry(model,'Juvinall_8_33_cantilever_spring.stl');
...
view(0,80);
title('Link, Face-2 is fixed and Face-7 has line load.')
...
structuralBoundaryLoad (model,'Face',7,'SurfaceTraction',[0,-distributedLoad,0]);

%% Discretization
hmax = 5; % Thickness of horizontal plate with hole, meters
